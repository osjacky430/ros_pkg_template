...
function (configure_linker)
  ...
  if (_cxx_supports_linker)
    find_program(LD_PROGRAM ${_LINKER_NAME})
    if (LD_PROGRAM)
      target_link_options(${_TARGET} INTERFACE ${_linker_flag})
    else ()
      message(STATUS "Linker provided isn't valid as we can't find the program, using default linker.")
    endif ()
  elseif (_LINKER_PATH AND CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
    ...
    find_program(LD_PROGRAM ld HINTS ${_LINKER_PATH} NO_DEFAULT_PATH)
    if (LD_PROGRAM)
