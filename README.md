...
### Compiler, Build tools
  ...
  - Build tools
    ...
    As of now (2022/07/10), [catkin_tools still doesn't support specifying generator](https://github.com/catkin/catkin_tools/issues/267). Therefore, the only option left is Unix makefile.. :(
...
To enhance the quality of our code, we should use as many tools as possible to help us finding bugs in the early stage. If you are not going to use docker, then you'll need to install these tools manually.
...
``` sh
catkin test --this # catkin run_test --this for older version of catkin
```

Notice you must run `catkin build --this` before `catkin test --this`, this can be easily forgotten and lead to some stupid mistake.
